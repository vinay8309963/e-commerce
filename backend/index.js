...
const username = 'vinay8309963';
const password = encodeURIComponent('Vinay@992106'); // Encode password
const dbName = 'e-commerce';
const clusterUrl = 'cluster0.ybndrps.mongodb.net';
...
app.post('/login', async (req,res) => {
    ...
    if(user){
        ...
        res.json({success:false,errors:"User does not exist with this email Id"})
    }
})
